...
CAS:SetPosition("M1", UDim2.new(1, -130, 1, -130))
CAS:SetPosition("C",  UDim2.new(1, -130, 1, -210))
CAS:SetPosition("X",  UDim2.new(1, -130, 1, -290))
CAS:SetPosition("Z",  UDim2.new(1, -280, 1, -130))
CAS:SetPosition("R",  UDim2.new(1, -280, 1, -210))
CAS:SetPosition("F",  UDim2.new(1, -280, 1, -290))
CAS:SetPosition("L",  UDim2.new(1, -280, 1, -370))
CAS:SetTitle("F", "equip mate")
CAS:SetTitle("R", "big jump")
CAS:SetTitle("Z", "spinny")
CAS:SetTitle("X", "the 8bit mega blade")
