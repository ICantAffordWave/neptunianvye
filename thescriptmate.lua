...
basgui.Parent = plr.PlayerGui -- detectable...
basgui.Name = "VISgui"
...
function eightbitmegablade()
	...
	a.CanCollide = false
	local ray = Ray.new(
		orb.CFrame.Position,                           -- origin
		(mouse.Hit.Position - orb.CFrame.Position).Unit * 500 -- direction
	) 
	local ignore = orb
...
CAS:BindAction("F", CAS1, true, Enum.KeyCode.F, Enum.KeyCode.ButtonY)
CAS:BindAction("R", CAS2, true, Enum.KeyCode.R, Enum.KeyCode.ButtonA)
CAS:BindAction("Z", CAS3, true, Enum.KeyCode.Z, Enum.KeyCode.ButtonX)
CAS:BindAction("X", CAS4, true, Enum.KeyCode.X, Enum.KeyCode.ButtonB)
CAS:BindAction("C", CAS5, true, Enum.KeyCode.C, Enum.KeyCode.ButtonR1)
CAS:BindAction("L", CAS6, true, Enum.KeyCode.L, Enum.KeyCode.ButtonL1)
CAS:BindAction("M1", CAS7, true, Enum.UserInputType.MouseButton1, Enum.KeyCode.ButtonR2)
CAS:SetPosition("F", UDim2.new(0.75, 0, 0.65, 0))
CAS:SetPosition("R", UDim2.new(0.85, 0, 0.65, 0))
CAS:SetPosition("Z", UDim2.new(0.75, 0, 0.75, 0))
CAS:SetPosition("X", UDim2.new(0.85, 0, 0.75, 0))
CAS:SetPosition("C", UDim2.new(0.75, 0, 0.85, 0))
CAS:SetPosition("L", UDim2.new(0.85, 0, 0.85, 0))
CAS:SetPosition("M1", UDim2.new(0.90, 0, 0.50, 0))
CAS:SetTitle("F", "equip mate")
CAS:SetTitle("R", "big jump")
CAS:SetTitle("Z", "spinny")
CAS:SetTitle("X", "the 8bit mega blaede")
CAS:SetTitle("C", "spin blade 2")
CAS:SetTitle("L", "mute musik")
CAS:SetTitle("M1", "attack yes")
