...
CAS:SetPosition("C",  UDim2.new(1, -130, 1, -190))
CAS:SetPosition("X",  UDim2.new(1, -130, 1, -250))
CAS:SetPosition("Z",  UDim2.new(1, -270, 1, -130))
CAS:SetPosition("R",  UDim2.new(1, -270, 1, -190))
CAS:SetPosition("F",  UDim2.new(1, -270, 1, -250))
CAS:SetPosition("L",  UDim2.new(1, -270, 1, -310))
CAS:SetTitle("F", "F")
CAS:SetTitle("R", "R")
CAS:SetTitle("Z", "Z")
CAS:SetTitle("X", "X")
